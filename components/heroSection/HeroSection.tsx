        ...
        <div className="md:text-center text-center space-y-2 md:space-y-4 z-10 ">
          ...
          <div className="">
            <Link href="/upload-product">
              <button className="py-3.5 px-9 bg-activeColor  rounded-md text-whiteColor relative  transition ease-in-out delay-150 duration-300 md:text-base text-sm   font-lexed font-medium  whitespace-nowrap shadow-xl w-full md:w-auto">
                List your product
              </button>
            </Link>
          </div>
