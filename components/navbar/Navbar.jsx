...
const Navbar = () => {
  ...
  return (
    <nav className=" w-full relative nav-container border-b bg-white border-slate-300  h-[70px] top-0 flex  items-center transition ease-in-out delay-150">
      <div className="nav-box flex justify-between items-center  w-full">
        ...
        <div className="w-1/6 font-bold lg:text-center text-[#cc0000] text-[25px] lg:text-[40px]	">
