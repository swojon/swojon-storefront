  ...
  return (
    <section className="min-w-[300px] border rounded-md min-h-screen  h-full sticky">
      <div className="flex justify-between items-center p-3 border-b ">
        <h6 className="text-base font-lexed text-primaryColor">Filter by:</h6>
      ...
      <div className="py-4 px-3">
        <span className="block text-base pb-3 text-primaryColor font-lexed">
          Ad Posted by
        </span>
        <AdDropdown />
      </div>

      <form className="hidden lg:block p-3">
